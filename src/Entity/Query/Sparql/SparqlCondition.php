...
class SparqlCondition extends ConditionFundamentals implements ConditionInterface {
   ...
   * {@inheritdoc}
   */
  public function __construct($conjunction, SparqlQueryInterface $query, array $namespaces, SparqlEntityStorageGraphHandlerInterface $sparql_graph_handler, SparqlEntityStorageFieldHandlerInterface $rdf_field_handler) {

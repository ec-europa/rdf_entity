...
/**
 * Provides a form class for RDF entity graphs.
 */
class RdfEntityGraphForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state): array {
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => [RdfEntityGraph::class, 'load'],
        'source' => ['name'],
      ],
    ...
    $form['entity_types'] = [
      ...
      '#disabled' => $graph->id() === RdfEntityGraphInterface::DEFAULT,
